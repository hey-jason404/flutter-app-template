...
| 任務 | 去哪 |
|---|---|
| 加一個新 feature | `dart run tool/new_feature.dart <name>` 產生骨架 + 接線,後續步驟見 [`docs/how-to/add-a-feature.md`](docs/how-to/add-a-feature.md) |
...
flutter run -t app/lib/main_dev.dart               # 跑 dev 環境(stg/prod 同理換檔名)
```
